...
//	public String getHotelRoom(@RequestParam("id") int id, Model model) {
//		HotelRoomDTO dto = hotelService.getHotelAndRoom(id);
//		model.addAttribute("gethotel", dto.getHotel());
//		model.addAttribute("roomdetails", dto.getRoom());
//		return "list-hotel-room";
//	}
//}